function findNeedle(haystack) {
    return `found the neddle at position ${haystack.indexOf("needle")}`;
}
...
console.log(`Answer: ${findNeedle(haystack_1)}`, "found the needle at position 3");
console.log(`Answer: ${findNeedle(haystack_2)}`, "found the needle at position 5");
console.log(`Answer: ${findNeedle(haystack_3)}`, "found the needle at position 30");